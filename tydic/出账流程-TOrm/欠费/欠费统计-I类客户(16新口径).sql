...
Select  B.AREA_NAME 分公司,
	...
	Left Join PU_INTF.I_PRD_VIP_ACCT Partition(P201711) C
		On A.ACCT_ID = C.ACCT_ID
	 And TO_CHAR(EXP_DATE, 'YYYYMM') >= '201711'
 Where A.IS_I_FLAG = 1
 AND A.MONTH_NO='201711'
...
select * from PU_busi_IND.bm_OWE_KN_NEW03 where month_no='201711'
